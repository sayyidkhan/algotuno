...
const sample_model = nn_model(
    training_dataset_2018.tensor_xs_data,
    training_dataset_2018.tensor_ys_data
);
    ...
    .finally(() => {
        ...
        predict(
            ...
            .then((_predict) => {
                ...
                let _validation_result = generate_plot_line(validation_dataset_2019.original_xs_data.flat().map(x => [x[0], new Date(x[1])]), "validation");
