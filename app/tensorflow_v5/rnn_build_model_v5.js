...
function run_build_model(_company_name, _stock_data, _save_dir_name) {
    ...
    train_model(
        ...
        .then((_training_output) => {
            ...
            sample_model.save(_save_dir_name);
        ...
        .finally(() => {
            ...
            predict(
                ...
                if (visualise_graph_on_nodeplotlib) {
